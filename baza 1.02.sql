...
CREATE TABLE Vrednostni_papirji (
    ...
    Kratica CHAR(4) NOT NULL UNIQUE,    -- Kratica se bo uporabljala kot primarni ključ pri določanju vrste vrednostnega papirja
...
CREATE TABLE Vrednosti_od_papirjev(
    ...
    CONSTRAINT ID_Papirja_kratica FOREIGN KEY (ID) REFERENCES Vrednostni_papirji(Kratica) -- Ključ v drugi tabeli, je naveden kot kratica, da so podatki bolj pregledni
);
